...
public class ServiceResourceIT {
    private static final String DEFAULT_NOMSERVICE = "AAAAAAAAAA";
    private static final String UPDATED_NOMSERVICE = "BBBBBBBBBB";
     ...
     *
     * @see com.mycompany.myapp.repository.search.ServiceSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Service createEntity(EntityManager em) {
        Service service = new Service().nomservice(DEFAULT_NOMSERVICE);
        return service;
    }
    ...
    public static Service createUpdatedEntity(EntityManager em) {
        Service service = new Service().nomservice(UPDATED_NOMSERVICE);
        return service;
    }
    ...
    public void createService() throws Exception {
        ...
        assertThat(testService.getNomservice()).isEqualTo(DEFAULT_NOMSERVICE);
    ...
    public void getAllServices() throws Exception {
        ...
        restServiceMockMvc
            ...
            .andExpect(jsonPath("$.[*].nomservice").value(hasItem(DEFAULT_NOMSERVICE)));
    }
    ...
    public void getService() throws Exception {
        ...
        restServiceMockMvc
            ...
            .andExpect(jsonPath("$.nomservice").value(DEFAULT_NOMSERVICE));
    }
    ...
    public void updateService() throws Exception {
        ...
        updatedService.nomservice(UPDATED_NOMSERVICE);
        ...
        Service testService = serviceList.get(serviceList.size() - 1);
        assertThat(testService.getNomservice()).isEqualTo(UPDATED_NOMSERVICE);
    ...
    public void searchService() throws Exception {
        ...
        // Initialize the database
        serviceRepository.saveAndFlush(service);
        when(mockServiceSearchRepository.search(queryStringQuery("id:" + service.getId()))).thenReturn(Collections.singletonList(service));

        // Search the service
        restServiceMockMvc
            .perform(get("/api/_search/services?query=id:" + service.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(service.getId().intValue())))
            .andExpect(jsonPath("$.[*].nomservice").value(hasItem(DEFAULT_NOMSERVICE)));
